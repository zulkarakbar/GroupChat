...
function addMessageOnReload(){
	...
	if(message!=null){
		...
		xhttp.open("GET", "http://localhost:8080/getMessages?data="+message, true);
...
<BODY onLoad="addMessageOnReload()" bgcolor="#FFFFFF">
	...
	<table style="width: 100%; border: 0">
		<tr>
			<td width="100%" valign="top"><%@ include file="header.jsp"%>
				<table>
					<tr>
						<td>

							<div class="left_div">
								<p style="left: 30px;" id="logger">
									<b><%=(String) session.getAttribute("uname")%> </b>
								</p>
								<p style="left: 70px;">
									<b>you are in room <%=roonName%></b>
								</p>
							</div>
				...
				<table class="users">
					<tr>
						<td>
							<table>
								<tr>
									<td><span class="show_users"><%=chatRoom.getNoOfChatters()%>
 ...
 %>
	...
	<div class="type_msg">
		<div class="input_msg_write">
			<input type="text" placeholder="Type a message" id="messagebox"
				onkeypress="javascript:doit_onkeypress(event);" />
		</div>
	</div>
	<button class="msg_send_btn" type="button" value="Send"
		id="sendmessage" onClick="addMessage()">
		<i class="fa fa-paper-plane-o" aria-hidden="true"></i>
	</button>
		<form  action="login" method="get">
		<button class="logout_button" type="submit" value="logout" id="logout">Logout</button>
		</form>
</BODY>
</HTML>